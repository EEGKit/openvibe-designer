	...
	public:
		...
		public:
			...
			virtual OpenViBE::boolean callback(
			        ...
			        const IVisualisationTree& rVisualisationTree)=0;
		};
		...
		/**
			 ...
			 */
		virtual IVisualisationTree& getVisualisationTree(
		        const OpenViBE::CIdentifier& rVisualisationTreeIdentifier)=0;
		/**
		...
		virtual OpenViBE::boolean enumerateVisualisationTrees(
		        IVisualisationManager::IVisualisationTreeEnum& rCallBack) const=0;
