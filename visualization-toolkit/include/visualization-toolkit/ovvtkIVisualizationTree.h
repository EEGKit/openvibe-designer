...
namespace OpenViBEVisualizationToolkit
{
	...
	struct ITreeViewCB
	{
		...
		virtual const char* getTreeWidgetIcon(
		        OpenViBEVisualizationToolkit::EVisualisationTreeNode eVisualisationTreeNode)
		{
			return "";
		}
	...
	public:
		...
		virtual OpenViBE::boolean getNextVisualisationWidgetIdentifier(
		        ...
		        OpenViBEVisualizationToolkit::EVisualisationWidgetType oType) const=0;
		...
		/**
			 ...
			 */
		virtual IVisualisationWidget* getVisualisationWidget(
		        const OpenViBE::CIdentifier& rIdentifier) const=0;
		...
		/**
			 ...
			 */
		virtual IVisualisationWidget* getVisualisationWidgetFromBoxIdentifier(
		...
		virtual OpenViBE::boolean addVisualisationWidget(
		        ...
		        EVisualisationWidgetType oType,
		...
		virtual unsigned long getULongValueFromTreeIter(
		        ...
		        EVisualisationTreeColumn eVisualisationTreeColumn) const=0;
		...
		virtual OpenViBE::boolean findChildNodeFromRoot(
		        ::GtkTreeIter* pIter,
		        const char* pLabel,
		        EVisualisationTreeNode eType)=0;
