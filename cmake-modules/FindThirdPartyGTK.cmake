...
IF(GTK_FOUND)
	...
	IF(WIN32)
		...
		INSTALL(
			DIRECTORY ${OV_CUSTOM_DEPENDENCIES_PATH}/gtk/bin/
			DESTINATION ${CMAKE_INSTALL_FULL_BINDIR}
			FILES_MATCHING PATTERN "*.dll")
		INSTALL(
			DIRECTORY ${OV_CUSTOM_DEPENDENCIES_PATH}/gtk/lib/gtk-2.0/2.10.0/engines
			DESTINATION ${CMAKE_INSTALL_FULL_LIBDIR}/gtk-2.0/2.10.0/
			FILES_MATCHING PATTERN "*.dll")
		INSTALL(
			FILES ${OV_CUSTOM_DEPENDENCIES_PATH}/gtk/etc/gtk-2.0/gtkrc
