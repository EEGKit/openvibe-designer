...
IF(PATH_CURL)
	...
	IF(WIN32)
		...
		IF(CURLLIB)
			debug_message( "    [  OK  ] lib ${CURLLIB}")
		ELSE(CURLLIB)
			MESSAGE(WARNING "    [FAILED] lib curllib ${PATH_CURL}")
			RETURN()
		ENDIF(CURLLIB)
		...
		IF(LIBCURL_IMP)
			debug_message( "    [  OK  ] lib ${LIBCURL_IMP}")
		ELSE(LIBCURL_IMP)
			MESSAGE(WARNING "    [FAILED] lib libcurl_imp ${PATH_CURL}")
			RETURN()
		ENDIF(LIBCURL_IMP)
		...
		IF(LIBEAY32)
			debug_message( "    [  OK  ] lib ${LIBEAY32}")
		ELSE(LIBEAY32)
			MESSAGE(WARNING "    [FAILED] lib libeay32 ${PATH_CURL}")
			RETURN()
		ENDIF(LIBEAY32)
		...
		IF(LIB_OPENLDAP)
			debug_message( "    [  OK  ] lib ${LIB_OPENLDAP}")
		ELSE(LIB_OPENLDAP)
			MESSAGE(WARNING "    [FAILED] lib openldap ${PATH_CURL}")
			RETURN()
		ENDIF(LIB_OPENLDAP)
		...
		IF(LIB_SSLEAY32)
			debug_message( "    [  OK  ] lib ${LIB_SSLEAY32}")
		ELSE(LIB_SSLEAY32)
			MESSAGE(WARNING "    [FAILED] lib ssleay32 ${PATH_CURL}")
			RETURN()
		ENDIF(LIB_SSLEAY32)
	...
	IF(UNIX)
		...
		IF(CURLLIB_STATIC)
			debug_message( "    [  OK  ] lib ${CURLLIB_STATIC}")
		ELSE(CURLLIB_STATIC)
			MESSAGE(WARNING "    [FAILED] lib curllib_static")
			RETURN()
