...
if(NOT DEFINED TRIED_FIND_OVSDK)
	if(MULTI_BUILD)
		...
		foreach( OUTPUTCONFIG ${CMAKE_CONFIGURATION_TYPES} )
			...
			find_path(OPENVIBE_SDK_PATH_TMP include/openvibe/ov_all.hpp PATHS ${SEEK_PATHS} PATH_SUFFIXES openvibe-sdk-${OUTPUTCONFIG} ${OUTPUTCONFIG} NO_DEFAULT_PATH)
		...
		find_path(OPENVIBE_SDK_PATH include/openvibe/ov_all.hpp PATHS ${LIST_DEPENDENCIES_PATH} PATH_SUFFIXES openvibe-sdk-${OV_SDK_BUILD_TYPE} NO_DEFAULT_PATH)
