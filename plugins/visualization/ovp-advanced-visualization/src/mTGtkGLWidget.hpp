...
#define M_GRADIENT_SIZE 128
				...
				if (m_textureId == 0)
				{
					...
					OpenViBEVisualizationToolkit::ColorGradient::parse(gradientBase, str.c_str());
					OpenViBEVisualizationToolkit::ColorGradient::interpolate(gradient, gradientBase, M_GRADIENT_SIZE);
