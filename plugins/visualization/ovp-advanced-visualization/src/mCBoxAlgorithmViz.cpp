...

{
	...
	g_signal_connect(::gtk_builder_get_object(m_Builder, "spinbutton_time_scale"), "value-changed", G_CALLBACK(::spinbutton_time_scale_change_value_callback),
					 m_RendererCtx);
...
bool CBoxAlgorithmViz::processClock(CMessage& /*msg*/)
{
