...
{
	if (ui32Index < m_vChannelName.size()) { return m_vChannelName[ui32Index]; }
...
uint32_t CRendererContext::getChannelCount() const { return m_vChannelName.size(); }

uint32_t CRendererContext::getSelectedCount() const { return m_vChannelLookup.size(); }

uint32_t CRendererContext::getSelected(uint32_t ui32Index) const { return m_vChannelLookup[ui32Index]; }
...
float CRendererContext::getScale() const { return m_f32Scale * (m_pParentRendererContext ? m_pParentRendererContext->getScale() : 1); }

float CRendererContext::getZoom() const { return m_f32Zoom * (m_pParentRendererContext ? m_pParentRendererContext->getZoom() : 1); }

float CRendererContext::getRotationX() const { return m_f32RotationX + (m_pParentRendererContext ? m_pParentRendererContext->getRotationX() : 0); }

float CRendererContext::getRotationY() const { return m_f32RotationY + (m_pParentRendererContext ? m_pParentRendererContext->getRotationY() : 0); }

// ____________________________________________________________________________________________________________________________________________________________________________________
//

float CRendererContext::getTranslucency() const { return m_f32Translucency * (m_pParentRendererContext ? m_pParentRendererContext->getTranslucency() : 1); }

float CRendererContext::getAspect() const { return m_f32Aspect * (m_pParentRendererContext ? m_pParentRendererContext->getAspect() : 1); }

uint64_t CRendererContext::getSampleDuration() const { return m_ui64SampleDuration; }

uint64_t CRendererContext::getTimeScale() const { return m_ui64TimeScale; }

uint64_t CRendererContext::getElementCount() const { return m_ui64ElementCount; }

uint64_t CRendererContext::getFlowerRingCount() const { return m_ui64FlowerRingCount; }

bool CRendererContext::hasXYZPlotDepth() const { return m_bHasXYZPlotDepth; }

bool CRendererContext::isAxisDisplayed() const { return m_bIsAxisDisplayed; }

bool CRendererContext::isPositiveOnly() const { return m_bIsPositiveOnly; }

bool CRendererContext::isFaceMeshVisible() const { return m_bFaceMeshVisible; }

bool CRendererContext::isScalpMeshVisible() const { return m_bScalpMeshVisible; }

bool CRendererContext::isTimeLocked() const { return m_bIsTimeLocked; }

bool CRendererContext::isScrollModeActive() const { return m_bIsScrollModeActive; }

bool CRendererContext::getCheckBoardVisibility() const { return (m_pParentRendererContext ? m_pParentRendererContext->getCheckBoardVisibility() : m_bCheckBoardVisiblity); }

bool CRendererContext::getScaleVisibility() const { return (m_pParentRendererContext ? m_pParentRendererContext->getScaleVisibility() : m_bScaleVisiblity); }

IRendererContext::EDataType CRendererContext::getDataType() const { return m_eDataType; }

uint32_t CRendererContext::getSpectrumFrequencyRange() const { return m_ui32SpectrumFrequencyRange; }

uint32_t CRendererContext::getMinSpectrumFrequency() const { return m_ui32MinSpectrumFrequency > m_ui32SpectrumFrequencyRange ? m_ui32SpectrumFrequencyRange : m_ui32MinSpectrumFrequency; }

uint32_t CRendererContext::getMaxSpectrumFrequency() const { return m_ui32MaxSpectrumFrequency > m_ui32SpectrumFrequencyRange ? m_ui32SpectrumFrequencyRange : m_ui32MaxSpectrumFrequency; }

uint32_t CRendererContext::getStackCount() const { return m_ui32StackCount; }

uint32_t CRendererContext::getStackIndex() const { return m_ui32StackIndex; }

// ____________________________________________________________________________________________________________________________________________________________________________________
//

bool CRendererContext::isERPPlayerActive() const { return m_bERPPlayerActive || (m_pParentRendererContext ? m_pParentRendererContext->isERPPlayerActive() : false); }
