...
namespace OpenViBEDesigner
{
	...
	public:
		...
		template <class T>
		bool addAttribute(const OpenViBE::CIdentifier& attributeID, const T& rValue) const;

		bool removeAttribute(const OpenViBE::CIdentifier& attributeID);

		bool removeAllAttributes();

		template <class T>
		T getAttributeValue(const OpenViBE::CIdentifier& attributeID) const;

		template <class T>
		bool setAttributeValue(const OpenViBE::CIdentifier& attributeID, const T& rValue);
