...
namespace OpenViBE
{
	namespace Designer
	{
	class CVisualizationWidget final : public OpenViBE::VisualizationToolkit::IVisualizationWidget
	{
	public:
		explicit CVisualizationWidget(const Kernel::IKernelContext& ctx) : m_kernelCtx(ctx) { }
		~CVisualizationWidget() override = default;

		bool initialize(const CIdentifier& id, const CString& name, const OpenViBE::VisualizationToolkit::EVisualizationWidgetType type,
		...
		OpenViBE::VisualizationToolkit::EVisualizationWidgetType getType() const override { return m_type; }
	...
	private:
		...
		CString m_name;
		OpenViBE::VisualizationToolkit::EVisualizationWidgetType m_type = OpenViBE::VisualizationToolkit::VisualizationWidget_Undefined;
