...
CAbstractSettingView::CAbstractSettingView(Kernel::IBox& box, const uint32_t index, const char* sBuilderName, const char* sWidgetName): m_rBox(box), m_index(index), m_settingWidgetName("")
{
