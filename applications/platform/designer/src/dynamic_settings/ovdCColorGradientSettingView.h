...
namespace OpenViBEDesigner
{
	namespace Setting
	{
		...
		{
		public:
			CColorGradientSettingView(OpenViBE::Kernel::IBox& box, const uint32_t index, OpenViBE::CString& rBuilderName, const OpenViBE::Kernel::IKernelContext& rKernelContext);
